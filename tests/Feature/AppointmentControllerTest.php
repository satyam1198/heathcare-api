...
class AppointmentControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Correct model for factory use
        $users = User::factory()->count(2)->create();
        $this->actingAs($users->first());
    }

    
    public function test_it_returns_user_appointments()
    {
    ...
    public function test_it_books_an_appointment_successfully()
    {
    ...
    public function test_it_fails_to_book_due_to_conflict()
    {
        $request = Request::create('/api/appointments', 'POST', []);
    ...
    public function test_it_cancels_an_appointment_successfully()
    {
    ...
    public function test_it_prevents_cancel_if_less_than_24_hours()
    {
        $this->mockRepo->shouldReceive('cancelAppointment')
            ->once()
            ->with(1, Auth::id())
    ...
    public function test_it_marks_appointment_as_completed()
    {
    ...
    public function test_it_returns_404_if_completion_fails()
    {
        $this->mockRepo->shouldReceive('completeAppointment')
            ->once()
            ->with(1, Auth::id())
